    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Column(
            children: (child.length > 3 ? Layer.build(child[3], buildContext) : null)
          ) ,
          Column(
            children: (child.length > 4 ? Layer.build(child[4], buildContext) : null)
          )  ,
          Column(
            children: (child.length > 5 ? Layer.build(child[5], buildContext) : null)
          ) 
        ]
      )  
    );
