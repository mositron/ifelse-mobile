...
class CheckoutPage extends StatelessWidget {
  CheckoutPage({Key key, this.par}) : super(key: key);
  final Map<String, dynamic> par;

  @override
  Widget build(BuildContext context) {
    return MaterialApp(title: Site.name, home: _CheckoutPage(), debugShowCheckedModeBanner:false);
  }
}
...
class CheckoutPageScreenState extends State<_CheckoutPage> with SingleTickerProviderStateMixin {
  bool _status = true;
  ...
  void _uploadCheckoutPage(ImageSource source, {BuildContext context}) async {
    try {
                        ...
                        Padding(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                GestureDetector(
                                  onTap: () {
                                    _uploadCheckoutPage(ImageSource.gallery, context: context);
                                  },
                                  child: CircleAvatar(
